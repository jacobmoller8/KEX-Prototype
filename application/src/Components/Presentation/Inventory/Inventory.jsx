			...
			for (let key in currentInventory) {
				inventoryList.push(
					<tr key={currentInventory[key].EANcode}>
						...
						<td> <Button className="delItemBtn" onClick={()=> this.props.onDelete(currentInventory[key])}>  <img className="tableIcon" src={require('../../../Images/Icons/delete.svg')} alt="shoppingIcon"></img> </Button></td>
					</tr>)
			}
